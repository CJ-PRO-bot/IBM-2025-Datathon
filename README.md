...
As shown in the flow chart, admin priortize valid photos, and then the recheck_photo saving time and energy, while ensuring immediate response to the reports 
